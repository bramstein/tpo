...
tpo.util.TextMetrics = function() {
    ...
    // read body.offsetWidth to trigger the initial recalc
    window.document.body.offsetWidth;


    console.time('computing font metrics');
    ...
    console.timeEnd('computing font metrics');
    ...
    console.time('looking up dimensions');
    ...
    console.timeEnd('looking up dimensions');
