        ...
        if (this.previousTokenClass) {
            if (token.tokenClass === Token.Class.SP) {
                this.previousToken.breakAction = BreakAction.Type.PROHIBITED;
                    ...
                    token.tokenClass === Token.Class.BK ||
                    token.tokenClass === Token.Class.NL ||
                    token.tokenClass === Token.Class.LF ||
                    token.tokenClass === Token.Class.CR
                ) {
                this.previousToken.breakAction = BreakAction.Type.PROHIBITED;
                this.previousTokenClass = (token.tokenClass === Token.Class.CR) ? Token.Class.CR : Token.Class.BK;
            } else if (this.previousTokenClass === Token.Class.CR || this.previousTokenClass === Token.Class.BK) {
                this.previousToken.breakAction = BreakAction.Type.EXPLICIT;
                ...
                if (breakAction === BreakAction.Type.INDIRECT) {
                    ...
                    this.previousToken.breakAction = breakAction;
                    this.previousTokenClass = token.tokenClass;
                }
            }
            this.data.emit(this.previousPosition, this.previousToken);
            ...
            if (token.tokenClass === Token.Class.LF || token.tokenClass === Token.Class.NL) {
                token.tokenClass = Token.Class.BK;
            }
